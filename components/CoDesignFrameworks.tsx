...
function CoDesignFrameworks({}: Props) {
  return (
    <div className="flex flex-col mx-auto items-start md:max-w-5xl p-10">
      <h1 className="text-4xl font-bold ">Co-Design Frameworks</h1>
      <div className="flex flex-col space-y-5 pt-10">
        <h2 className="text-xl font-semibold">What is it about?</h2>
      ...
      <div className="flex flex-col mt-10 space-y-5">
        <h1 className="text-4xl font-semibold">Types of Frameworks</h1>
        <ul className="list-disc pl-5 space-y-3">
          <li className="text-lg">Solution Based Program Design</li>
          <li className="text-lg">LFA/TOC</li>
          <li className="text-lg">M&E Framework</li>
        </ul>
      </div>
      <div className="flex flex-col mt-10 space-y-5">
        <h1 className="text-4xl font-bold">Solution Based Program Design</h1>
        <h1 className="text-xl font-semibold">How we do?</h1>
        <ul className="list-disc pl-5 space-y-3">
      ...
      <div className="flex flex-col mt-10 space-y-5">
        <h1 className="text-4xl font-bold">SLFA/TOC</h1>
        <h1 className="text-xl font-semibold">Logical Framework Approach</h1>
        <p className="text-lg text-balance">
      ...
      <div className="flex flex-col mt-10 space-y-5">
        <h1 className="text-xl font-semibold">Theory of Change</h1>
        <p className="text-lg text-balance">
      ...
      <div className="flex flex-col mt-10 space-y-5">
        <h1 className="text-4xl font-bold">M&E Framework</h1>
        <h1 className="text-xl font-semibold">Financial Planning Consulting</h1>
        <p className="text-lg text-balance">
